...
if __name__ == "__main__":
    ...
    welcome_page.setWindowTitle('CryptoLearner - Welcome Page')
    ...
    instruction_page.setWindowTitle('CryptoLearner - Instruction Page')
    ...
    sender_page.setWindowTitle('CryptoLearner - Sender Page')
    ...
    receiver_page.setWindowTitle('CryptoLearner - Receiver Page')
    ...
    welcome_title = QtWidgets.QLabel('Welcome to CryptoLearner!', welcome_page)
    ...
    getting_started_button.setStyleSheet('background-color: indigo; color: white;')
    ...
    instruction1 = QtWidgets.QLabel('You and a friend Bob use the Diffe-Hellman key exchance to share a secret key x. \n',
                                    instruction_page)
    instruction1.setFont(body_font)
    instruction2 = QtWidgets.QLabel('Using this secret key, you can encrpyt a secret message to send to Bob! \n',
                                    instruction_page)
    instruction2.setFont(body_font)
    instruction3 = QtWidgets.QLabel('Enter the message that you would like to send to bob below: \n', instruction_page)
    ...
    process_button.setStyleSheet('background-color: indigo; color: white;')
    ...
    def on_process_click():
        ...
        explanation2 = QtWidgets.QLabel(f'Converted ASCII Value: {ascii_text} \n', sender_page)
        explanation2.setFont(body_font)

        explanation3 = QtWidgets.QLabel(
            f'Step 2: We convert the ASCII values to our cipher text using Elgamal. Elgamal '
        ...
        encrypted = QtWidgets.QLabel(f'Cipher Text: {encrypted_msg} \n', sender_page)
        ...
        receiver_button.setStyleSheet('background-color: indigo; color: white;')
    ...
    def on_receiver_click():
        ...
        explanation5 = QtWidgets.QLabel(str(encrypted_msg) + "\n", receiver_page)
        ...
        explanation7 = QtWidgets.QLabel(f"Reconverted ASCII Text: {decrypt_ascii_text} \n", receiver_page)
        ...
        explanation9 = QtWidgets.QLabel(f"Reconverted ASCII Text: {regular_text} \n", receiver_page)
        ...
        explanation10 = QtWidgets.QLabel("Bob knows that " +
                                         ...
                                         " signatues ensure authenticity through a provided verification key. \n",
                                         receiver_page)
        ...
        goback_welcome_button.setStyleSheet('background-color: indigo; color: white;')
